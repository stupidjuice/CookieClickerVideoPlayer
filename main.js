...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.shimmer=function(type,obj,noCount, xc = 0, yc = 0)
		{
			this.type=type;
		...
		Game.shimmer.prototype.init=function(xc, yc)//executed when the shimmer is created
		{
			Game.shimmerTypes[this.type].initFunc(this, xc, yc);
		}
		...
		Game.shimmerTypes={
			...
			'golden':{
				...
				initFunc:function(me, xc = 0, yc = 0)
				{
